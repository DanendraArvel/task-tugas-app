    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <div class="actions">
                    @if($task->status != 'expired')
                        <a href="/tasks/{{ $task->id }}/answer" class="btn-info">Jawab</a>
                    @endif
                    <a href="/tasks/{{ $task->id }}" class="btn-info">Detail</a>
                    @if (auth()->user()->token == 'admin')
                        <a href="/tasks/{{ $task->id }}/listAnswer" class="btn-info">List Jawaban</a>
                        <a href="/tasks/{{ $task->id }}/edit" class="btn-warning">Edit</a>
...
<div class="empty">
    ...
    @if (auth()->user()->token == 'admin')
        <a href="/tasks/create" class="btn btn-primary">+ Tambah Data Pertama</a>
    @endif
</div>
@endif
