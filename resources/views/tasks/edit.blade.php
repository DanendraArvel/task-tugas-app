...
<div class="form-container">
    ...
    <form method="POST" action="/tasks/{{ $task->id }}">
        ...
        <div class="form-group">
            ...
            <input type="text" name="title" value="{{ old('title', $task->title) }}" maxlength="100" required>
            @error('title')
        ...
        <div class="form-group">
            ...
            <input type="text" name="description" value="{{ old('description', $task->description) }}" maxlength="255" required>
            @error('description')
                <div class="error">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="form-group">
            <label>File *</label>
            <input type="file" name="attachment" value="{{ old('attachment', $task->attachment) }}">
            @error('attachment')
                <div class="error">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="form-group">
            <label>Guru *</label>
            <select name="guru" id="guru" value="{{ old('guru') }}" required>
                <option value="" disabled selected>Pilih Guru</option>
                @foreach ($users as $user)
                    <option value="{{ $user->name }}" {{ old('guru') == $user->name ? 'selected' : '' }}>
                        {{ $user->name }}
                    </option>
                @endforeach
            </select>
